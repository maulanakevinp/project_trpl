    ...
    <div class="card shadow h-100 mb-3">
        ...
        <div class="card-body">
            <form action="{{ route('salaries.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="">@lang('salary.salary')</label>
                    <div class="col-sm-9">
...
<!-- Modal -->
<div class="modal fade" id="modalEditSalary" tabindex="-1" role="dialog"
            ...
            <form id="postModal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="purposeEdit" type="text" class="form-control" name="tujuan">{{ old('tujuan') }}</textarea>
                    </div>
                </div>
    ...
    function editModal(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#postModal').attr('action',"{{url('/salaries')}}"+"/"+data.id);
