                    ...
                    <tbody>
                        ...
                        @foreach($salaries as $salary)
                            <tr>
                                ...
                                <td>
                                    <a href="" data-toggle="modal" data-target="{{'#editSubmissionModal'.$i}}"><span class="badge badge-warning">{{ __('salary.verify') }}</span></a>
                                </td>
                            </tr>
                                        ...
                                        <form action="{{ route('salary.verify2',$salary->id) }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="terbilang" type="text" class="form-control" name="terbilang" value="{{ $salary->be_calculated }}" disabled>
                                                </div>
                                                <div class="form-group">
