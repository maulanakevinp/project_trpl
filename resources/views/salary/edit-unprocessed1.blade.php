                ...
                <div class="card-body">
                    <form action="{{ route('salary.verify1',$salary->id) }}" method="post">
                        ...
                        <div class="float-right">
                            <a href="{{ route('salary.unprocessed1') }}" class="btn btn-secondary">@lang('salary.back')</a>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <img id="nik_image" class="mw-100" src="{{url('img/nik/'.$salary->user->nik_file) }}" alt="{{ $salary->user->nik_file }}">
            </div>
        </div>
    </div>
</div>
