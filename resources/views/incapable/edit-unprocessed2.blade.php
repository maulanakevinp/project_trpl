    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card shadow h-100">
                ...
                <div class="card-body">
                    <form action="{{ route('incapable.verify2',$incapable->id) }}" method="post">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alasan_pengajuan" id="alasan_pengajuan" class="form-control" cols="30" rows="5"
                                disabled>{{ $incapable->reason }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="float-right">
                            <a href="{{ route('incapable.unprocessed2') }}" class="btn btn-secondary">
                                @lang('incapable.back')
                            </a>
                            <button type="Submit" class="btn btn-primary" id="submitMenu">
                                @lang('incapable.verify')
                            </button>
                        </div>
                    </form>
                </div>
